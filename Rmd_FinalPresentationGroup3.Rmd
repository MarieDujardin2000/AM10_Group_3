...
url_Region <- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/Region.csv"
Region <- read_csv(url_Region)
url_Policy<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/Policy.csv"
Policy <- read_csv(url_Policy)
url_SearchTrend<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/SearchTrend.csv"
SearchTrend <- read_csv(url_SearchTrend)
url_Time<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/Time.csv"
Time <- read_csv(url_Time)
url_TimeAge<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/TimeAge.csv"
TimeAge <- read_csv(url_TimeAge)
url_TimeGender<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/TimeGender.csv"
TimeGender <- read_csv(url_TimeGender)
url_TimeProvince<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/TimeProvince.csv"
TimeProvince <- read_csv(url_TimeProvince)
url_Weather<- "https://raw.githubusercontent.com/MarieDujardin2000/AM10_Group_3/main/Weather.csv"
Weather <- read_csv(url_Weather)
url_Case<- "https://github.com/MarieDujardin2000/AM10_Group_3/blob/main/Case.csv"
Case <- read_csv(url_Case)
...
```{r}
merge <- merge(SearchTrend, Time, by = "date")
glimpse(merge)
```
...
```{r}
merge <- merge(SearchTrend, Time_cleaned, by = "date")
glimpse(merge)
```
...
combined_plot <- plot_grid(a, b, ncol = 1, align = "v")
combined_plot
```
